    ...
    <section id="about" className="py-20 px-6 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative overflow-hidden">
      ...
      <div className="flex-1 text-center md:text-left relative z-10">
        <div>
          ...
          <a href="#skills"
             className="inline-block px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg shadow-lg hover:from-blue-600 hover:to-purple-700 transition-all transform hover:scale-105">
            See More
          </a>
        </div>
        ...
        <div className="mt-10 grid grid-cols-3 gap-3 text-center">
          <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
            <p className="text-2xl sm:text-3xl font-semibold text-blue-600">02</p>
            <p className="text-xs sm:text-sm text-gray-600">Years<br />experience</p>
          </div>
          <div className="bg-purple-50 p-3 sm:p-4 rounded-lg">
            <p className="text-2xl sm:text-3xl font-semibold text-purple-600">10+</p>
            <p className="text-xs sm:text-sm text-gray-600">Completed<br />project</p>
          </div>
          <div className="bg-green-50 p-3 sm:p-4 rounded-lg">
            <p className="text-2xl sm:text-3xl font-semibold text-green-600">03</p>
            <p className="text-xs sm:text-sm text-gray-600">Companies<br />worked</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex justify-center items-center relative z-10">
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          {/* Social icons — vertical column, shrinks on mobile */}
          <div className="flex flex-col gap-3 sm:gap-4 -translate-x-2 sm:translate-x-0">
            <a href="https://wa.me/60186605356" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 sm:w-12 sm:h-12 bg-green-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg hover:shadow-xl">
            ...
            <a href="https://www.linkedin.com/in/zhan-heng-cho-6902b1238/" target="_blank" rel="noopener noreferrer"
               className="w-12 h-12 sm:w-12 sm:h-12 bg-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg hover:shadow-xl">
              <svg className="w-6 h-6 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:tp068635@mail.apu.edu.my"
               className="w-12 h-12 sm:w-12 sm:h-12 bg-red-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg hover:shadow-xl">
              <svg className="w-6 h-6 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="relative">
            ...
            <div className="relative w-64 h-64 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full overflow-hidden">
